...
namespace L13.Controllers
{
   public class ChartController : Controller
   {
        ...
        private void PrepareData(int x)
      {
         ...
         List<FYP1.Models.Answer> list = DBUtl.GetList<FYP1.Models.Answer>("SELECT answer1, answer2, answer3, answer4, answer5, answer6, answer7, answer8, answer9, answer10, answer11, answer12, answer13, answer14, answer15, answer16, answer17 FROM FeedbackAns");
